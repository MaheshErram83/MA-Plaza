...
export async function POST(req) {
  ...
  if (action === "addContribution") { await store.addContribution(id, body.memberId, body.amount); return NextResponse.json({ ok: true }); }
  ...
  if (action === "advanceReimbursement") { return NextResponse.json(await store.advanceReimbursement(id, body.reimbId, body.toStatus, body.note)); }
